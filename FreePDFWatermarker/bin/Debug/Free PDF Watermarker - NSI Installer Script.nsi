...
;copy translations end
  ...
  !define MUI_FILE "FreePDFWatermarker"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Free PDF Watermarker 4dots"
  !define PRODUCT_SHORTCUT "Free PDF Watermarker 4dots"
  !define PRODUCT_VERSION "1.2"
  
  !define MUI_ICON "free-pdf-watermarker-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Free PDF Watermarker 4dots"
  OutFile "FreePDFWatermarkerSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Free PDF Watermarker 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Free PDF Watermarker 4dots - User's Manual.url.lnk" "$INSTDIR\Free PDF Watermarker 4dots - User's Manual.url" "" "$INSTDIR\Free PDF Watermarker 4dots - User's Manual.url" 0
...
;Add files
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Free PDF Watermarker 4dots - User's Manual.url";
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Free PDF Watermarker 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Free PDF Watermarker 4dots" "InstallationDirectory" $INSTDIR
...
!endif
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreePDFWatermarkerExt64.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
; 32bit things here
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreePDFWatermarkerExt32.dll
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Free PDF Watermarker 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Free PDF Watermarker 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/free-pdf-watermarker/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/free-pdf-watermarker/how-to-use.php?afterinstall=true"
FunctionEnd
